...
export default function CTAButton({ 
  ...
  const baseClasses = "font-neue font-bold rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl relative overflow-hidden";
  ...
  return (
    ...
    >
      <span className="relative z-10" style={{color: textColor || (variant === 'primary' ? 'black' : 'white')}}>{children}</span>
